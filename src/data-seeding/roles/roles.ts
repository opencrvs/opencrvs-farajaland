...
export const roles: Role[] = [
  {
    ...
    scopes: [
      ...
      'search[event=new-birth,access=all]',
      ...
      `record.create[event=birth|death|tennis-club-membership|new-birth]`,
      'record.declare[event=birth|death|tennis-club-membership|new-birth]',
      'record.notify[event=birth|death|tennis-club-membership|new-birth]'
    ]
  },
  {
    ...
    scopes: [
      ...
      'record.create[event=birth|death|tennis-club-membership|new-birth]',
      'record.read[event=birth|death|tennis-club-membership|new-birth]',
      'record.declare[event=birth|death|tennis-club-membership|new-birth]',
      'record.declared.validate[event=birth|death|tennis-club-membership|new-birth]',
      'record.declared.reject[event=birth|death|tennis-club-membership|new-birth]',
      'record.declared.archive[event=birth|death|tennis-club-membership|new-birth]',
      'record.declared.review-duplicates[event=birth|death|tennis-club-membership|new-birth]',
      'record.registered.print-certified-copies[event=birth|death|tennis-club-membership|new-birth]',
      'record.registered.request-correction[event=birth|death|tennis-club-membership|new-birth]'
    ]
  },
  {
    id: 'LOCAL_REGISTRAR',
    ...
    scopes: [
      ...
      'record.declared.archive[event=birth|death|tennis-club-membership|new-birth]',
      'record.declared.review-duplicates[event=birth|death|tennis-club-membership|new-birth]',
      'record.register[event=birth|death|tennis-club-membership|new-birth]',
      'record.registered.print-certified-copies[event=birth|death|tennis-club-membership|new-birth]',
      'record.registered.correct[event=birth|death|tennis-club-membership|new-birth]',
      'record.unassign-others[event=birth|death|tennis-club-membership|new-birth]'
    ]
  },
  {
