...
export const roles: Role[] = [
  {
    ...
    scopes: defineScopes([
      ...
      { type: 'record.search', options: { registeredIn: 'administrativeArea' } },
      { type: 'record.create', options: { placeOfEvent: 'administrativeArea' } },
      { type: 'record.read', options: { placeOfEvent: 'administrativeArea' } },
      { type: 'record.read', options: { registeredIn: 'administrativeArea' } },
  ...
  },
  {
    ...
    scopes: defineScopes([
      ...
      { type: 'record.search', options: { registeredIn: 'location' } },
      ...
      { type: 'record.read', options: { registeredIn: 'location' } },
