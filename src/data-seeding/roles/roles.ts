...
export const roles: Role[] = [
  {
    ...
    scopes: [
      ...
      'type=record.search&declaredIn=administrativeArea',
      'type=record.create&placeOfEvent=administrativeArea',
      'type=record.read&declaredIn=administrativeArea',
      'type=record.declare&placeOfEvent=administrativeArea',
      'type=record.edit&declaredIn=administrativeArea',
      'type=record.reject&declaredIn=administrativeArea',
      ...
      'type=record.custom-action&event=birth&customActionTypes=VALIDATE_DECLARATION,ESCALATE&declaredIn=administrativeArea',
      'type=record.custom-action&event=birth&customActionTypes=ISSUE_CERTIFIED_COPY&registeredIn=administrativeArea',
  ...
  },
  {
    ...
    scopes: [
      ...
      'type=record.reject&declaredIn=administrativeArea',
      'type=record.archive&declaredIn=administrativeArea',
      'type=record.review-duplicates&declaredIn=administrativeArea',
      'type=record.register&declaredIn=administrativeArea',
      'type=record.print-certified-copies&registeredIn=administrativeArea',
      'type=record.correct&registeredIn=administrativeArea',
      'type=record.custom-action&event=birth&customActionTypes=ESCALATE&declaredIn=administrativeArea',
      'type=record.custom-action&event=birth&customActionTypes=ISSUE_CERTIFIED_COPY&registeredIn=administrativeArea',
