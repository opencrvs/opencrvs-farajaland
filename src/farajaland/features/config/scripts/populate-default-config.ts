...
export default async function importCertificates() {
  try {
    ...
    const deathCertificate = new Certificate({
      ...
      event: 'death',
      status: 'ACTIVE',
      svgDateUpdated: 1646208407425.0,
