...
import {
  NEW_BIRTH_DECLARATION_FORM,
  NEW_BIRTH_DECLARATION_REVIEW
...
export const newBirthEvent = defineConfig({
  id: Event.NEW_BIRTH,
  declaration: NEW_BIRTH_DECLARATION_FORM,
  label: {
    defaultMessage: 'New birth',
    description: 'This is what this event is referred as in the system',
    id: 'event.newBirth.label,'
  },
  ...
  actions: [
    {
      ...
      review: NEW_BIRTH_DECLARATION_REVIEW
    },
    {
