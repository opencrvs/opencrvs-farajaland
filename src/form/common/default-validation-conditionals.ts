...
export const isDeceasedAddressNotAvailable =
  '!(draftData && draftData.deceased?.countryPrimaryDeceased)'

export const isMotherAddressNotAvailable =
  '!(draftData && draftData.mother?.countryPrimaryMother)'
