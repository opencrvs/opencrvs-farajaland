...
test('Birth Record correction flow', async ({ browser }) => {
  ...
  await test.step('Record correction', async () => {
  ...
  await test.step('Record correction action appears in audit history', async () => {
    await page.reload()
  ...
  await test.step('Record Correction audit history modal opens when action is clicked', async () => {
    await page
