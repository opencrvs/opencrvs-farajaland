...
test('Validate collect payment page', async ({ browser }) => {
  ...
  await test.step('5.2 should be able to select any type of id and corresponding id input will be visible', async () => {
  ...
  await test.step("5.7 Fill all mandatory field and click 'Continue' should navigate to affidavit page", async () => {})
