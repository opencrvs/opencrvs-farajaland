...
test('8. Validate declaration review page', async ({ browser }) => {
  ...
  // test.skip('8.1.5 Validate the declaration send button')
  ...
  // test.skip('8.2.3 Validate supporting document')
  // test.skip('8.2.4 Validate additional comments box')
  // test.skip('8.2.5 Validate the declaration send button')
  ...
  // test.skip('8.3.3 Validate supporting document')
  // test.skip('8.3.4 Validate additional comments box')
  // test.skip('8.3.5 Validate the register button')
