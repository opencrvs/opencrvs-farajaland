...
test('4. Workqueue flow - 4', async ({ browser }) => {
  ...
  await test.step('4.1 Declare by HO', async () => {
    ...
    // 4.1.6 Fill up informant comment & signature
